                ...
                <div className="sec-1">
                    ...
                    <div className="logos">
                        ...
                        <div className="language">
                            <svg class="seo-pages-0" data-testid="IconCanada" fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M6.7 22.7c1.6.8 3.4 1.3 5.3 1.3s3.7-.5 5.3-1.3V1.3C15.7.5 13.9 0 12 0S8.3.5 6.7 1.3v21.4z" fill="#fff"></path><path d="M6.7 1.3C2.7 3.2 0 7.3 0 12c0 4.7 2.7 8.8 6.7 10.7V1.3zm10.6 0v21.5c3.9-2 6.7-6 6.7-10.7 0-4.8-2.7-8.9-6.7-10.8zM15.8 11l-.5 1 .4.1c.1.1.1.2.1.3 0 .1 0 .2-.1.3L14.4 14h-1.6l-.3 1.5c0 .1-.1.1-.1.1h-.5c-.1 0-.1-.1-.1-.1l-.3-1.5H9.9l-1.3-1.3c-.1-.1-.1-.2-.1-.3 0-.1 0-.2.1-.3l.2-.2-.5-1v-.1h.1l1 .5.2-.2c.1-.1.4-.1.8.1.067.067.133.044.2.022a.322.322 0 0 1 .1-.022s.1-.2.1-.3l-.3-1.5v-.1h.1l1 .5.5-1.5c0-.1.1-.1.1 0l.5 1.5 1-.5h.1v.1l-.3 1.5c-.1.1 0 .3.1.3.1.1.2.1.3 0 .2-.2.4-.2.6 0l.2.2 1-.5h.1v.1z" fill="#FF3131"></path></svg>
                            <p>English</p>
                        </div>
                    </div>
                </div>
